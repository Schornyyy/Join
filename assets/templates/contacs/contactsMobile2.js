...
function deleteContactMobile(contactId) {
  ...
  showDeleteConfirmationModalMobile(contactId);
}

function showDeleteConfirmationModalMobile(contactId) {
  const modalContent = document.createElement("div");
  modalContent.classList.add("modal-content-mobile");
  modalContent.innerHTML = /*html*/ `
    <p class="removeContactConfirmationTextMobile">Delete Contact?</p>
    <div class="cancelContactDesktopDeleteButtonConfirmationContainerMobile">
      <button class="cancelContactMobileDeleteButton" onclick="confirmDeleteContact('${contactId}')">Delete</button>
      <button class="cancelContactMobileDeleteButton" onclick="cancelDeleteMobile()">Cancel</button>
    </div>    
  `;
  const contactsContent = document.querySelector(".contactsContent");
  contactsContent.appendChild(modalContent);
}
...
function confirmDeleteContact(contactId) {
  ...
  contactsInit();
  closeDeleteConfirmationModalMobile();
}
...
function closeDeleteConfirmationModalMobile() {
  const modalContent = document.querySelector(".modal-content-mobile");
  if (modalContent) {
    modalContent.remove();
  }
}