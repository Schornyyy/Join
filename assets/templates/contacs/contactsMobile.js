...
function updateContactsByFirstLetter(
  ...
  if (!contactsByFirstLetter[firstLetter]) {
    contactsByFirstLetter[firstLetter] =
      createLetterAndContactsContainer(firstLetter);
  }
...
function createOneContactContainer(oneContact) {
  return /*html*/ `
      <div class="oneContactContainer" onclick="openContactScreenMobile(${
        oneContact.id
      })">
        <div>
...
function constForCreateContactMobile() {
  ...
  const mailInput = document.querySelector(
    ".addContactInputMailAddresssMobile"
  );
...
function createEditContactHTML(selectedContact) {
  return /*html*/ `
      ...
      <form id="editcontactFormMobileID" onsubmit="updateContactMobile(${
        selectedContact.id
      })">
        <div class="addContactContainerFooter">
          <input class="addContactInputNameMobile" type="text" required placeholder="Name" value="${
            selectedContact.name
          }">
          <input class="addContactInputMailAddresssMobile" type="text" required placeholder="E Mail" value="${
            selectedContact.email
          }">
          <input class="addContactInputPhoneMobile" type="text" required placeholder="Phone" value="${
            selectedContact.phone
          }">
          <div>
            <img class="createContactButtonImg" src="../assets/img/contact/editContactDeleteButtonImg.svg" alt="" onclick="deleteContact(${
              selectedContact.id
            })">
            <img class="createContactButtonImg" src="../assets/img/contact/editContactSaveButtonImg.svg" alt="" onclick="updateContactMobile(${
              selectedContact.id
            })">
          </div>
        </div>
...
function updateContactMobile(contactId) {
  ...
  if (validateInputs(updatedInputs)) {
    ...
    if (!existingContact) {
      ...
      const updatedContactsData = updateContactsData(
        contactId,
        updatedInputs,
        hasChanged
      );
...
function createContactScreenHTML(selectedContact) {
  return /*html*/ `
    ...
    <div class="openContactContainerFooter">
        ...
        <a class="openContactEmailLink" href="mailto:${
          selectedContact.email
    ...
    <div class="dropdown-container" id="contactOptionsDropdownContainer">
        ...
        <div class="dropdown-menu" id="contactOptionsDropdown">            
            <div class="dropdown-option" data-value="edit" onclick="editContactScreen(${
              selectedContact.id
            })">
...
function singleMemberToHTMLOpenContactMobile(member, index) {
  ...
  return `
      <div class="openContactUserImgMobile" style="background-color: ${
        member.colorCode
